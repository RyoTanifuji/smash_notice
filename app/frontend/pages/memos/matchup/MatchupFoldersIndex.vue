              ...
              >
                ...
                <v-menu activator="parent">
                  <v-list density="compact">
                    ...
                    <v-list-item @click="handleFolderDelete">
                      <v-list-item-title>
  ...
  <div class="justify-center">
    ...
    >
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn @click="handleCloseFolderCreateDialog">
            キャンセル
          </v-btn>
          <v-btn
            class="mr-4"
...
export default {
  ...
  mounted() {
    this.$store.dispatch("memos/fetchFolders", "matchup");
  },
  methods: {
